...
function doProvAndCityRelation1() {
  ...
  if ($("#chooseCity1").length === 0) {
    city.append("<option id='chooseCity1' value='-1'>你所在城市</option>");
  }
  if ($("#chooseCounty1").length === 0) {
    county.append("<option id='chooseCounty1' value='-1'>你所在区/县</option>");
  }
  ...
  $.each(cityJson,
    function(i, val) {
      if (val.item_code.substr(0, 2) == $("#province1").val().substr(0, 2) && val.item_code.substr(2, 4) != '0000' && val.item_code.substr(4, 2) == '00') {
        aa.append("<option value='" + val.item_code + "'>" + val.item_name + "</option>");
      }
    });

  $("#chooseCity1").after(aa.toString());
}
...
function doCityAndCountyRelation1() {
  ...
  $("#chooseCounty1").after(sb1.toString());
